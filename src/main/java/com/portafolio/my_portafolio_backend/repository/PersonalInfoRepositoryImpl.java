...
public class PersonalInfoRepositoryImpl implements  IPersonalInfoRepository{
    ...
    //el final o constantes se deben inicializar o estar en el constructor, lo podemos usar manual o usando lombok
    ...
    //interfaz funcional, manejan un metodo estatico
