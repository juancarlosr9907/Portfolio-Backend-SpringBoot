...
('Juan', 'Carlos', 'Backend Developer', 'Apasionado por el desarrollo backend con experiencia en Java, Spring Boot y React. Disfruto construyendo soluciones robustas y escalables.', 'img/dev-gabriel.png', 5, 'juan.perez@example.com', '+5491112345678', 'https://linkedin.com/in/juanperez', 'https://github.com/juanperez');
